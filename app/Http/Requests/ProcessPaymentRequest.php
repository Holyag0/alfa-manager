...
class ProcessPaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'method' => 'required|in:pix,credit_card,debit_card,cash,bank_transfer,check,boleto',
    ...
    public function messages(): array
    {
        return [
            ...
            'method.in' => 'O método de pagamento deve ser: PIX, cartão de crédito, cartão de débito, dinheiro, boleto, transferência bancária ou cheque.',
