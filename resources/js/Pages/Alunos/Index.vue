<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Search Component -->
    <TransitionRoot :show="true" as="template" appear>
      <div class="relative">
        <Dialog class="relative z-10" :open="true" @close="() => {}">
                      ...
                      <div class="flex flex-auto flex-col justify-between p-6">
                        <dl class="grid grid-cols-1 gap-x-6 gap-y-3 text-sm text-gray-700">
                          <template v-if="activeOption.phone">
                            <dt class="col-end-1 font-semibold text-gray-900">Telefone</dt>
...
import { ChevronRightIcon, UsersIcon, UserIcon, PlusIcon } from '@heroicons/vue/24/outline'
import {
  Combobox,
  ComboboxInput,
  ComboboxOptions,
...
// Buscar alunos iniciais ao carregar a página
onMounted(() => {
  fetchStudents('')
})
