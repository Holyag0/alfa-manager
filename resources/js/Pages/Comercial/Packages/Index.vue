<template>
  <div class="min-h-screen">
        ...
        <div class="py-6 md:flex md:items-center md:justify-between">
          <div class="flex-1 min-w-0">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <h1 class="text-2xl font-bold text-sky-700">Pacotes</h1>
                <strong class="text-sm text-gray-500">Gerencie os pacotes de serviços da escola</strong>
              </div>
            </div>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Paginação -->
        <div v-if="packages.links" class="mt-6">
...
const search = (searchFilters = filters) => {
  router.get(route('packages.index'), searchFilters, {
    preserveState: true,
    preserveScroll: true
  })
}
