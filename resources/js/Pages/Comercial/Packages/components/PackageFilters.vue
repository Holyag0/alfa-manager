      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">Filtre os pacotes por nome, categoria ou status</p>
          </div>
        </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input 
                  ...
                  class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm transition-all duration-200 bg-gray-50 focus:bg-white"
                />
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select 
                  ...
                  class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm transition-all duration-200 appearance-none bg-gray-50 focus:bg-white"
                >
          ...
          <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            ...
            <div class="flex items-center space-x-3">
              <button 
                ...
                type="button"
                class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors duration-200"
              >
                Fechar
              </button>
              <button 
                type="submit"
                class="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-violet-600 rounded-lg hover:from-purple-700 hover:to-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
