      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">Filtre os serviços por nome, categoria ou status</p>
          </div>
        </div>
        ...
        <form @submit.prevent="handleApplyFilters" class="p-6">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input 
                  ...
                  class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm transition-all duration-200 bg-gray-50 focus:bg-white"
                />
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <select 
                  ...
                  class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm transition-all duration-200 appearance-none bg-gray-50 focus:bg-white"
                >
          ...
          <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            ...
            <div class="flex items-center space-x-3">
              ...
              <button 
                type="submit"
                class="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
