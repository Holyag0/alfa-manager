        ...
        <div class="py-6 md:flex md:items-center md:justify-between">
          <div class="flex-1 min-w-0">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <h1 class="text-2xl font-bold text-sky-700">Editar Cargo</h1>
                <strong class="text-sm text-gray-500">Atualize as informações do cargo</strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <form @submit.prevent="submit" class="p-6">
          ...
          <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            >
              ...
              {{ processing ? 'Atualizando...' : 'Atualizar Cargo' }}
            </button>
          </div>
        </form>
      </div>
...
const submit = () => {
  ...
  form.put(route('cadastros.positions.update', props.position.id), {
    onFinish: () => {
