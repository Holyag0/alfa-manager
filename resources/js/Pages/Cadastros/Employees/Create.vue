    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div class="bg-white shadow rounded-lg p-6 mb-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-gray-900">Novo Colaborador</h1>
            <p class="text-sm text-gray-600 mt-1">Cadastre um novo colaborador</p>
          </div>
          <Link
...
const submit = () => {
  form.post(route('cadastros.employees.store'), {
    forceFormData: true
  })
}
</script>
